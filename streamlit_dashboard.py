...
st.markdown("## Red Wine Analysis")   ## Main Title

################# Scatter Chart Logic #################

st.sidebar.markdown("### Scatter Chart: Analiza la relación entre ingredientes:")
...
st.sidebar.markdown("### Bar Chart: Media de ingredientes por tipo de vino: ")
...
if bar_axis:
    bar_fig = avg_wine_df[bar_axis].iplot(kind="bar",
                        barmode="stack",
                        xTitle="Wine Type",
                        title="Distribución de la media de ingredientes por tipo de vino",
                        asFigure=True,
                        opacity=1.0,
                        );
else:
